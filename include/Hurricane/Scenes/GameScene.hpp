...
namespace hur {
	...
	public:
		GameScene(inf::TextureManager& _textureManager, CollisionSystem& _collisionSystem, KinematicSystem& _kinematicSystem, PlayerControlSystem& _playerControlSystem, 
			ProjectileControlSystem& _projectileControlSystem, PickupControlSystem& _pickupControlSystem, EntityFactory& _entityFactory);
		...
		PickupControlSystem& m_PickupControlSystem;
