...
namespace itr {
	...
	public:
		TowerSpawnerService(inf::InputManager& _inputManager, IntrusionConfigurationManager& _config, ITowerPlaceableSurfaceService& _towerPlaceableSurfaceService);
	...
	protected:
		...
		bool attemptPlacingGhost(const sf::Vector2i& _eventCoordinates);
