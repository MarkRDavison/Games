...
namespace sov {
	...
	TitleScene::TitleScene(inf::FontManager& _fontManager, ISceneChangeService& _sceneChangeService) :
		inf::Scene("sov::TitleScene"),
		m_FontManager(_fontManager),
		m_SceneChangeService(_sceneChangeService),
		m_TitleText("Sovereign", m_FontManager.getFont("DEBUG"), 144),
